(function () {
  ...
  function loadStyles() {
    ...
    link.id = CSS_ID;
    link.rel = 'stylesheet';
    link.href = '/plugin/emcoreTodo/todo-widget.css?v=0.1.0';
  ...
  function mount() {
    ...
    root.setAttribute('data-proof-version', '0.1.0');
    ...
    panel.innerHTML =
      ...
      '<div class="emcore-todo-proof__body">' +
        ...
        '</div>' +
      '</div>' +
      '<div class="emcore-todo-proof__foot">مرحله آزمایشی ۰٫۱٫۰</div>';
